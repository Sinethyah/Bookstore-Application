...
export default class BooksList extends Component{
    ...
    searchBook(){
        BookDataService.findByAuthorFullName(this.state.searchAuthorfname, this.state.searchAuthorlname)
        .then(response => {
            this.setState({
    ...
    render(){
        ...
        const { searchAuthorfname, searchAuthorlname, books, currentUser, order} = this.state;
            ...
            <div className="center">
                ...
                {currentUser ? (
                    <div>
                        ...
                        <h4>Search for books with Author First Name or Last Name or both </h4>
