...
export default class BooksList extends Component{
    ...
    constructor(props){
        ...
        this.searchBookByGenre = this.searchBookByGenre.bind(this);
    ...
    searchBookByGenre() {
        ...
        BookDataService.findByGenre(this.state.searchGenre)
        .then(response => {
            this.setState({
    ...
    render(){
        ...
        const { searchGenre,  books, currentuser, order} = this.state;
        ...
        return(
            ...
            <div>
                ...
                {currentuser ? (
                    ...
                    <h4>Search for books with Genre</h4>
                    <div class="input-group">
                        ...
                        <input
                            ...
                            placeholder="Genre"
                            value={searchGenre}
                            onChange={this.onChangeSearchGenre}
                        />
                        ...
                        <button className="input-group-text"
                            onClick={this.searchBookByGenre}>
                                Search
                                </button>
                        </div>
