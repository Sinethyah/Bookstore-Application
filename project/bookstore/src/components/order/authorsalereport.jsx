...
export default class reportList extends Component{
    ...
    constructor(props){
        super(props);
        this.getAuthorSaleReport = this.getAuthorSaleReport.bind(this);
    ...
    componentDidMount(){
        this.getAuthorSaleReport();
    }

    getAuthorSaleReport() {
        OrderDataService.showAuthorSaleReport()
        .then(response => {
            this.setState({
            ...
            {!currentuser ? (
                ...
                <table className="table table-bordered" width="75%" >
                    ...
                    {report &&
                        ...
                        <td>{r.authorfname} {r.authorlname}</td>
                        <td>{r.quantitysum}</td>
